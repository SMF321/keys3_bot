...
user_menu_button = ['ℹ️ Информация о проекте ℹ️',
                    '🔍 Действующие предложения 🔎', '🕒 История моих обращений 🕤', '🔐 Секретный ключ 🔐']


def admin_menu_button():
    test = GET_ALL_NULL()
    admin_menu_button = ['Просмотр обращений по темам/Удалить обращение/Добавить в бан-лист',
                         'Добавить тему обращения', 'Удалилить тему обращения', f'Просмотр количества новых сообщений : {GET_ALL_NULL()}', 'Добавить секретную тему', 'Удалить секретную тему']
